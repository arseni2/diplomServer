...
import { HouseUpdateManyWithoutRealtorNestedInput } from '../house/house-update-many-without-realtor-nested.input';
import { AppealsUpdateManyWithoutClientNestedInput } from '../appeals/appeals-update-many-without-client-nested.input';

@InputType()
export class UserUpdateWithoutAppealsAsRealtorInput {
    ...
    @Field(() => HouseUpdateManyWithoutRealtorNestedInput, {nullable:true})
